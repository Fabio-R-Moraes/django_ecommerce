...
class Order(models.Model):
    ...
    shipping_address = models.ForeignKey(Address, related_name='shipping_adddress', on_delete=models.CASCADE, null=True, blank=True)
...
def pre_save_create_order_id(sender, instance, *args, **kwargs):
    ...
    #Retorna todos os Orders com essa instância de Cart,
    #excluindo aqueles que tem a mesma instância de billing_profile
