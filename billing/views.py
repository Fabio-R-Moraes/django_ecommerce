...
#View para renderizar a página de falha no pagamento
def payment_failed_view(request):
    return render(request, 'billing/payment-failed.html')

def payment_method_view(request):
    #Adicione um Long para ver se a chave está sendo passada
...
def create_payment_intent(request):
    ...
    try:
        ...
        #Substitua essa função pela sua lógica de preços
